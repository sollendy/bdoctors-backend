        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card border-0">
                    ...
                    <div class="card-body rounded-3 bg-light">
                        <form method="POST" action="{{ route('register') }}">
                            @csrf

                            <div class="row mb-2 flex-column align-content-center mt-5">


                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        class="form-control @error('name') is-invalid @enderror text-light" name="name"
                            ...
                            <div class="row mb-2 flex-column align-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="lastname" type="text"
                                        class="form-control @error('lastname') is-invalid @enderror text-light"
                            ...
                            <div class="row mb-2 flex-column align-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror text-light" name="email"
                            ...
                            <div class="row mb-0 justify-content-center my-5">
                                <div class="col-md-6 login d-flex justify-content-end">
                                    <button type="submit" id="confirm-button" class="btn btn-primary login fw-bold"
                                        disabled>
                                        {{ __('Register') }}
                                    </button>
                                </div>
                            ...
                            <span class="fs-9 bg-warning rounded-pill p-2">
